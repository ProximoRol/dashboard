...
/* memAutoExtract — ahora es un no-op.
   La extracción de insights se hace en copilot-ui.js via el backend.
   Esta función se mantiene para compatibilidad con cpSaveSession(). */
async function memAutoExtract(userMsg, assistantMsg) {
  // No-op: la extracción real la hace copilot-ui.js → backend → extract-insights
  return;
}
