/* ═══════════════════════════════════════════════════════════════
   ...
   Depende de: core.js (apiFetch), pipeline.js (_OPP_DATA), analytics.js
...
Sé directo. Sin introducción. Sin bullet points — usa párrafos cortos. En español.`;
  ...
  try {
    const data = await apiFetch('/api/claude-proxy', { method:'POST', body:{ module:'review', action:'alert-analysis', payload:{ alertas: ctx.alertas, canalesConectados: ctx.canalesConectados, periodo: ctx.periodo } } });
